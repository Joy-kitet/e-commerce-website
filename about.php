<main class="px-6 py-12 max-w-7xl mx-auto">
    <?php
    echo "<h2 class='text-2xl font-bold text-green-500'></h2>";
    ?>
 ...
 <body class="bg-white text-gray-900 font-sans">
  <header class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
   <div class="text-purple-700 font-extrabold text-lg select-none">
    ShopHub
   </div>
   <nav class="space-x-6 text-gray-600 text-sm font-normal">
    <a class="hover:text-gray-900" href="dashboard.php">
     Home
    </a>
    <a class="hover:text-gray-900" href="products.php">
     Products
    </a>
    <a class="hover:text-gray-900" href="about.php">
     About
    </a>
